...
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/januslo/react-native-bt-printer-mv/master/LICENSE) [![npm version](https://badge.fury.io/js/react-native-bt-printer-mv.svg)](https://www.npmjs.com/package/react-native-bt-printer-mv)

## Installation

### Step 1

Install via NPM [Check In NPM](https://www.npmjs.com/package/react-native-bt-printer-mv)

```bash
npm install react-native-bt-printer-mv --save
```

Or install via github

```bash
npm install https://github.com/januslo/react-native-bt-printer-mv.git --save
```
...
```bash
react-native link react-native-bt-printer-mv
```
...
import {
  ...
  BluetoothTscPrinter,
} from "react-native-bt-printer-mv";
```
